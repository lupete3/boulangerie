                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('categories.create')}}" class="btn btn-icon icon-left btn-success"><i class="fas fa-plus"></i> Ajouter catégorie</a>
                                </div>   
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        @foreach ($viewData['categories'] as $index => $categorie) 
                                            <tr>
                                                <td> {{ $index + 1 }} </td>
                                                <td> {{ $categorie->name }} 
