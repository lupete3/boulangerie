                        ...
                        <form method="post" action="{{ route('depenses.store')}}" enctype="multipart/form-data">
                          ...
                          <div class="card-body">
                            <div class="form-group">
                              <label>Motif de dépense*</label>
                              <input type="text" class="form-control" name="motif" value="{{ old('motif') }}" placeholder="" required="">
                            </div>
                            <div class="form-group">
                              <label>Montant dépense*</label>
                              <input type="text" class="form-control" name="montant" value="{{ old('montant') }}" placeholder="" >
                            </div>
                            <div class="form-group">
                              <label>Personne concernée*</label>
                              <input type="text" class="form-control" name="personne" value="{{ old('personne') }}" placeholder="" >
                            </div>
                          </div>
