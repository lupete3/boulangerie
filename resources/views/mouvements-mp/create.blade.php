        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                  ...
                  <div class="breadcrumb-item"><a href="{{ route('mouvement-stock-mp.index')}}">Mouvement stockmatières premières</a></div>
            ...
            <div class="section-body ">
                ...
                <div class="row">
                    <div class="col-12 col-md-12 col-lg-12 align-center">
                        ...
                        @endif
                      <div class="card ">
                        <form method="post" action="{{ route('mouvement-stock-mp.store')}}" enctype="multipart/form-data">
                            @csrf
                          <div class="card-header">
                            <h4>{{$viewData['title']}}</h4>
                            <div class="card-header-action">
                                <a href="{{ route('mouvement-stock-mp.index')}}" class="btn btn-icon icon-left btn-info"><i class="fas fa-list-alt"></i> Afficher les sorties matières premières</a>
                            </div> 
                          </div>
                          <div class="card-body">
