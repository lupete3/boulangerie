                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($viewData['sorties'] as $sortie)
                                            @php
                                                $tot+=($sortie->stockMaison->prix * $sortie->quantite)
                                            @endphp
                                            <tr>
                                                ...
                                                <td> {{ $sortie->stockMaison->prix }} Fc</td>
                                                <td> {{ $sortie->stockMaison->prix * $sortie->quantite }} Fc</td>
                                    ...
                                    <tr>
                                        <td colspan="6"><b>Total Valeur Sorties</b></td>
