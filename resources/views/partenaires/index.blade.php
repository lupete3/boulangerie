        ...
        <section class="section">
            <div class="section-header">
                ...
                <div class="section-header-breadcrumb">
                  ...
                  <div class="breadcrumb-item"><a href="{{ route('partenaires.index')}}">Partenaires</a></div>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped" id="table-1">
                                    ...
                                    <tbody>
                                        @foreach ($viewData['partenaires'] as $index => $partenaire) 
                                            <tr>
                                                <td> {{ $index + 1 }} </td>
                                                <td> {{ $partenaire->nom }} 
                                                <td> {{ $partenaire->created_at }} 
                                                ...
                                                <td>
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            ...
                                                            <a href="{{ route('partenaires.edit', $partenaire->id)}}" class="dropdown-item has-icon"><i class="far fa-edit text-primary"></i> Modifier</a>
