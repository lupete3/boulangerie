                            ...
                            <form method="post" action="{{ route('produits.update', $produit->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.01" class="form-control" name="kg_par_sac" value="{{ $produit->kg_par_sac }}" required>
                                    </div>

                                    <!-- Quantité par sac -->
                                    <div class="form-group">
                                        <label>Quantité par sac </label>
                                        <input type="number" step="0.01" class="form-control" name="qte_par_sac" value="{{ $produit->qte_par_sac }}" required>
                                    </div>
