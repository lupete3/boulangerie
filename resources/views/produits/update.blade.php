                            ...
                            <form method="post" action="{{ route('produits.update', $produit->id) }}" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form-control-sm" name="nom" value="{{ $produit->nom }}" required>
                                    </div>

                                    <!-- Prix -->
                                    <div class="form-group">
                                        <label>Prix*</label>
                                        <input type="number" step="0.01" class="form-control form-control-sm" name="prix" value="{{ $produit->prix }}" required>
                                    </div>

                                    <!-- Kg par sac -->
                                    <div class="form-group">
                                        <label>Kg par sac*</label>
                                        <input type="number" step="0.01" class="form-control form-control-sm" name="kg_par_sac" value="{{ $produit->kg_par_sac }}" required>
                                    </div>

                                    <!-- Quantité par sac -->
                                    <div class="form-group">
                                        <label>Quantité par sac </label>
                                        <input type="number" step="0.01" class="form-control form-control-sm" name="qte_par_sac" value="{{ $produit->qte_par_sac }}" required>
                                    </div>
